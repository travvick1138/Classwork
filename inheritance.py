__test__ = {
    ...
    >>> no_args_cat = Cat()
    >>> no_args_cat.is_animal
    True
    >>> no_args_cat.number_of_legs
    4
    >>> no_args_cat.speak()
    meow
    >>> no_args_cat.kind
    ...
    >>> no_args_pet_cat = PetCat()
    >>> no_args_pet_cat.is_animal
    True
    >>> no_args_pet_cat.number_of_legs
    4
    >>> no_args_pet_cat.speak()
    meow
    >>> no_args_pet_cat.kind
    'feline'
    >>> no_args_pet_cat.scratch()
    /neads couch
    >>> no_args_pet_cat.name is None
    True

    >>> pet_cat_with_arg = PetCat(name='Boris')
    >>> pet_cat_with_arg.is_animal
    True
    >>> pet_cat_with_arg.number_of_legs
    4
    >>> pet_cat_with_arg.speak()
    meow
    >>> pet_cat_with_arg.kind
    'feline'
    >>> pet_cat_with_arg.scratch()
    /neads couch
    >>> pet_cat_with_arg.name is None
    False
...
class Cat(Animal):
    """Blueprint for a cat (inherits from Animal)"""
...
class PetCat(Cat, Pet):
    """Blueprint for a cat that is also a pet"""
